...
public class Trainer extends PokemonHandler {
    ...
    private transient BattlePanel bp;
    private transient pkSelectorPanel pSp;
    private transient KeyHandler keyH;
    public String num; // "1","2","3","4"

    // Sprites
    private transient BufferedImage a1, a2, a3, a4, a5;
    ...
    private transient BufferedImage[] sprites = new BufferedImage[5]; // a1, a2, a3, a4, a5
