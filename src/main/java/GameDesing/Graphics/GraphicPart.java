...
public class GraphicPart {
    ...
    public static final int STATE_NURSE_JOY = 4;
    ...
    public static NurseJoyPanel nurseJoyPanel;
    ...
    public static void loadSavedGame() {
        ...
        boolean loaded = Utility.Lecture.SaveLoadManager.loadGame(game);
        
        if (loaded) {
            traderPanel = new TraderPanel(game); 
            cambiarPanel(STATE_TRADER);
        } else {
            JOptionPane.showMessageDialog(null, 
                "No se encontró un archivo de guardado.", 
                "Error de Carga", 
